...
You are running version 0.2.0 of Binary-like Encryptor."""
...
+ Added a size grip, letting the GUI be resized
  # It can also be resized manually, or be set to fullscreen
...
As stated in About.txt, this is a program used to encrypt messages into a binary-like form, and decrypt them back.
...
- Bring All to Front: Shows all windows of the application
- (window name): Toggles minimize mode
...
Contains information about Binary-like Encryptor, stored in text files.
Currently there are 3 text files: About.txt, Changelog.txt, and Help.txt (which is what you’re reading).
