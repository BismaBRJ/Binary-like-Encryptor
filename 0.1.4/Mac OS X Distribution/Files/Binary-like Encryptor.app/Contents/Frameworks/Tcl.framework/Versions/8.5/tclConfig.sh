...
# installed.
TCL_PREFIX='/Library/Tcl'

# Top-level directory in which Tcl's platform-specific files (e.g.
# executables) are installed.
TCL_EXEC_PREFIX='/Library/Tcl'
...
TCL_EXTRA_CFLAGS='-DALLOW_EMPTY_EXPAND -arch x86_64 -arch i386 -pipe   -isysroot /Developer/SDKs/MacOSX10.6.sdk -mmacosx-version-min=10.5 '
...
# build directory.
TCL_BUILD_LIB_SPEC='-F/Users/andreask/dbn/lba/GlobalBuildArena/builds/macosx10.5-ix86/tcl/unix/macosx10.5-ix86-framework -framework Tcl'
...
TCL_INCLUDE_SPEC='-I/Library/Frameworks/Tcl.framework/Versions/8.5/Headers'
...
# compiled.
TCL_SRC_DIR='/Users/andreask/dbn/lba/GlobalBuildArena/builds/macosx10.5-ix86/tcl'
...
# build directory.
TCL_BUILD_STUB_LIB_SPEC='-L/Users/andreask/dbn/lba/GlobalBuildArena/builds/macosx10.5-ix86/tcl/unix/macosx10.5-ix86-framework -ltclstub8.5'

# String to pass to linker to pick up the Tcl stub library from its
# installed directory.
TCL_STUB_LIB_SPEC='-L/Library/Frameworks/Tcl.framework/Versions/8.5 -ltclstub8.5'

# Path to the Tcl stub library in the build directory.
TCL_BUILD_STUB_LIB_PATH='/Users/andreask/dbn/lba/GlobalBuildArena/builds/macosx10.5-ix86/tcl/unix/macosx10.5-ix86-framework/libtclstub8.5.a'

# Path to the Tcl stub library in the install directory.
TCL_STUB_LIB_PATH='/Library/Frameworks/Tcl.framework/Versions/8.5/libtclstub8.5.a'
